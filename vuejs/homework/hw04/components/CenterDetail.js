export default {
  ...
  created() {
    ...
    let url = `https://api.odcloud.kr/api/15077586/v1/centers?page=${params}&perPage=1&serviceKey=nKMxQe1WMhoOgivWprVzhyy6pqRdKlcsRR4pWC3M1PLvi31aDuYyKDT7KHDYGviTS4y0uB1vO0Jb1aSY464a0A%3D%3D`;
    // url에서 파라미터정보 얻기.
    console.log(url);
